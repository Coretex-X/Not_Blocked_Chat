"""
chat_ui.py — все UI-компоненты, диалоги, пузыри сообщений,
             работа с файлами, голосовые сообщения, настройки
"""
